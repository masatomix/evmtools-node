...
| TC-ID | テスト内容 | 入力 | 期待結果 |
|-------|-----------|------|---------|
| TC-01 | 基準日がタスク期間中央 | 5日タスク、基準日=3日目 | 2（4,5日目）※基準日含まない |
| TC-02 | 基準日がタスク開始日 | 5日タスク、基準日=1日目 | 4（2,3,4,5日目）※基準日含まない |
| TC-03 | 基準日がタスク終了日 | 5日タスク、基準日=5日目 | 0（残日数なし）※基準日含まない |
| TC-04 | 土日を含むplotMap | 7日間、稼働5日 | 稼働日のみカウント（基準日除く） |
...
| TC-07 | 基準日が終了日 | 基準日=終了日 | 0（残日数なし）※基準日含まない |
...
| 1.1.1 | 2026-01-28 | remainingDays定義修正: 基準日を含まない（基準日終了時点の解釈）#156 | REQ-PV-TODAY-001 |
