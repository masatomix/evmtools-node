...
- [ ] 2. コア: Earned Schedule 数学ロジック
- [ ] 2.1 線形補間による ES 算出と境界処理
...
- [ ] 3.2 calculateEarnedSchedule メソッドと完了予測日の暦日展開
...
- [ ] 4. 検証: 単体・統合・終盤乖離の実証
- [ ] 4.1 (P) EarnedSchedule 数学コアの単体テスト
...
- [ ] 4.3 終盤の古典 SPI 1.0 収束 vs SPI(t) 乖離の実証テスト
...
- [ ] 5. ドキュメント・設計書の同期
- [ ] 5.1 (P) GLOSSARY への Earned Schedule 用語追加
...
- [ ] 5.3 (P) master 設計書（Project.spec.md）の同期
