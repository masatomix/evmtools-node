...
- [x] phase5-evmethod-knowledge-0.0.34 -- #171 EVM 知識ベース化（docs/EVM-KNOWLEDGE.md）を実施。evMethod（0/100,50/50）は一旦先送り後、**2026-07-06 に実装へ格上げ**（EV測定技法は PMI 標準のドメイン計算で利用側合成不可のため。phase5 spec の設計を再開）。機能化候補は #184/#185/#186 に起票。Dependencies: phase3-earned-schedule-0.0.32
