...
export const createStyles = (styles?: StyleFC) => {
  ...
  return function (instances: unknown[], workbook: XlsxPopulate.Workbook, sheetName: string): void {
    ...
    sheet.range(headerStartCell, headerEndCell).style('fill', { type: 'solid', color: { theme: 8, tint: '0.8' } })
